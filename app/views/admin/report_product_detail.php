...
<style>
    ...
    /* 4. BÊN TRÁI: CHART & INSIGHT (NỔI BẬT) */
    ...
    /* KHỐI PHÂN TÍCH NỔI BẬT (DARK STYLE) */
    .insight-card { 
        background: #111827; 
        color: #fff; 
        padding: 25px; 
    ...
    /* Hiệu ứng trang trí nhẹ cho khối Dark */
    .insight-card::before {
    ...
    .timeline-row { 
        ...
        padding: 12px 18px; cursor: pointer; transition: 0.2s; text-decoration: none; color: inherit;
    }
    ...
    .tm-ref { font-family: monospace; color: #3182ce; font-size: 12px; font-weight: 700; background: #eff6ff; padding: 2px 6px; border-radius: 4px; }
...
<div class="report-container">
    ...
    <div class="report-stats-grid">
        <div class="report-card">
            ...
            <span class="card-date"><?= date('d/m/Y', strtotime($_GET['start'])) ?></span>
        ...
        <div class="report-card">
            ...
            <span class="card-date">Trong kỳ lọc</span>
        ...
        <div class="report-card" style="background: #f0f7ff; border-color: #bfdbfe;">
            ...
            <span class="card-date"><?= date('d/m/Y', strtotime($_GET['end'])) ?></span>
    ...
    <div class="report-main-content">
        <div class="analysis-side">
            ...
            <div class="insight-card">
                <span class="insight-title"><i class="fa-solid fa-microchip"></i> Phân tích thông minh</span>
                <div class="insight-grid">
                    ...
                    <div class="insight-item">
                        ...
                        <?php 
                            $daysLeft = ($avg > 0) ? floor($stats['closing_stock'] / $avg) : 0;
                        ?>
        ...
        <div class="timeline-side">
            ...
            <?php 
            // Thứ tự từ trước đến nay (Cũ nhất ở trên)
        ...
        options: {
            ...
            plugins: {
                legend: { 
                    ...
                    position: 'top', 
                    align: 'end',
                    labels: { usePointStyle: true, font: { size: 12, weight: '700' }, padding: 20 }
                },
                tooltip: {
                    padding: 15,
