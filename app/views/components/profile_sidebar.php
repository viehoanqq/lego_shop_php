<link rel="stylesheet" href="/lego_shop_php/public/assets/css/profile.css" />
<aside class="profile-sidebar">
    <div class="profile-avatar">
        <img src="/lego_shop_php/public/assets/images/avt.png" alt="Avatar" class="avatar-img" />
        <h3 class="user-name">Nguyễn Việt Hoàng</h3>
    ...
    <nav class="profile-menu">
        ...
        <a href="/lego_shop_php/profile/address" class="menu-item <?= (isset($active_tab) && $active_tab == 'address') ? 'active' : '' ?>">
